...
<div class="accesos clearer">
	<section class="left tac">
		<div class="wrapper-ext"><a href="#" class="wrapper-in"><img src="<?php echo get_template_directory_uri(); ?>/img/logo-gies.png" alt="GIES Melgar"></a>
		</div>
	</section>
	<section class="left"><a href="#">
	...
	<div class="clearer">
		<div class="mitad left">
			<section>
				...
				<article class="mt5 portada"><a href="#">
